 ...
 * content is vertically (`items-center`) and
...
export default function LoginPage() {
  return (
    <div className="mx-auto flex w-full max-w-full gap-6 flex-1"> 
      <div className="flex w-full bg-[#f4f4f4]">
        {/* Left side */}
        <section className="flex flex-1 items-center justify-center px-6 py-10 md:px-16">
          <div className="w-full max-w-md">
            ...
            <p className="mt-3 text-sm text-muted-foreground md:text-base">
              More than 150* lessons are waiting for your next homeschool
              adventure!
            </p>
            <p className="text-xs text-muted-foreground pt-1">
              *exaggerated number for dramatic effect
            </p>
